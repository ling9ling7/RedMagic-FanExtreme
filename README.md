...
| 🔥 温控移除 | 所有温度墙拉到 999°C，满血释放 |
| 📳 振动增强 | 自定义 AW8697 线性马达增益 / 时长 / 电压上限 |
| 👆 触控优化 | 跟手度 4 档 + 960Hz 系统层 + 60 秒守护防回退 |
| 🔋 充电加速 | 解除部分情况下的充电电流限制 |
...
**Q: 开启触控优化时会在部分场景下断触或误触是为什么？**  
A: 这不是模块的bug而是系统导致的，触控优化功能提供了两个模式选择“全局”、“指定应用”，推荐使用“指定应用”模式，仅在指定包名的APP运行时才开启触控优化。
